...
Empty keymap to copy to each layer.
...
+-----------------------------------+                  +-----------------------------------+
               +-----------------+    +-----+  +-----+    +-----------------+
               | ALT |SUPER|LOWER|    |ENTER|  |SPACE|    |RAISE|BKSPC|SUPER|
               +-----------------+    +-----+  +-----+    +-----------------+
 */
...
layer_state_t layer_state_set_user(layer_state_t state) {
    // TODO: When the layer adjusts, we need to set the OLED to show what layer
    //       we are on so that I don't confuse myself.
